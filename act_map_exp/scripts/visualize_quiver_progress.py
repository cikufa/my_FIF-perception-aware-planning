...
(`per_iteration_quivers.txt`, legacy `quivers*_metrics.txt`, or legacy
`quivers*.txt`) and animates iteration progress in
RViz. It publishes:
- initial path (static)
- final path (static)
...
def resolve_quiver_file(run_dir: Path) -> Path:
    cands = [
        run_dir / "per_iteration_quivers.txt",
        run_dir / "quivers_path_yaw_metrics.txt",
        run_dir / "quivers_metrics.txt",
